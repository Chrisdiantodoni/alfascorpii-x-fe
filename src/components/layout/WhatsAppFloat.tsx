...
export default function WhatsAppFloat({ contact }: WhatsAppFloatProps) {
  ...
  return (
    <AnimatePresence>
      {isVisible && (
        <motion.div
          className="whatsapp-float fixed bottom-6 right-6 z-50 flex flex-col items-end"
        ...
        >
          ...
          <motion.button
            ...
            className="relative w-14 h-14 bg-[#25D366] text-white rounded-full flex items-center justify-center shadow-2xl hover:shadow-[#25D366]/30 focus-visible:ring-4 focus-visible:ring-[#25D366] focus-visible:ring-offset-2 dark:focus-visible:ring-offset-ink transition-all duration-300 outline-none group"
