...
## Corpus Check
- 172 files · ~206,789 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1133 nodes · 1674 edges · 108 communities (66 shown, 42 thin omitted)
...
Cohesion: 0.22
Nodes (7): MessageGallery(), DragScrollContainer(), DragScrollContainerProps, listVariants, MiniProductCard(), cms, useDragScroll()
...
Cohesion: 0.10
Nodes (19): Button(), ButtonAsAnchor, ButtonAsButton, ButtonAsLink, ButtonBaseProps, ButtonProps, motionFx, variants (+11 more)
...
Cohesion: 0.16
Nodes (12): auth, authClient, Route, Route, UserOverview(), navItems, Route, UserProfile() (+4 more)
...
Cohesion: 0.14
Nodes (13): defaultValues, InquiryForm(), SocialItem, SocialsGridProps, Section(), SectionProps, SectionLabel(), SectionLabelProps (+5 more)
...
Cohesion: 0.22
Nodes (9): BlogCard(), Image(), iconMap, MaterialIcon(), MaterialIconProps, MiniProductCardProps, BlogDetail(), getBlogDetail (+1 more)
...
Cohesion: 0.19
Nodes (11): Topbar(), TopbarProps, WishlistButton(), WishlistButtonProps, ProductDetail(), Route, getProductDetail, CartItem (+3 more)
...
Cohesion: 0.18
Nodes (10): Route, Route, Route, Route, Route, Route, Route, UserWishlist() (+2 more)
...
Cohesion: 0.24
Nodes (8): batchFiles(), batchFilesWithUrls(), FileableType, FileItem, FileItemWithUrl, files, storageUrl(), mapBanner()
...
Cohesion: 0.33
Nodes (5): getProductType(), Product, ProductCard(), ProductCardProps, zoneIcon
...
Cohesion: 0.29
Nodes (6): batchFiles, batchFilesWithUrls, FileableType, FileItem, FileItemWithUrl, getFiles
...
- **Why does `cms` connect `Layout Components` to `ProductCard.tsx`, `Cart Components`, `InquiryForm.tsx`, `CartDrawer.tsx`, `category/$slug.tsx`, `MaterialIcon.tsx`, `Faq.tsx`?**
